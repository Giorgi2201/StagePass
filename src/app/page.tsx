...
export default function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col relative bg-gradient-to-b from-[#181818] via-[#121212] to-[#121212]">
      <main className="w-full max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8 flex-1 flex flex-col justify-between relative z-10 space-y-10">
        {/* =========================================================
            AUTHENTICATED VIEW: SPOTIFY WIZARD WORKSPACE
           ========================================================= */}
        {isLoading ? (
          ...
          <div className="space-y-8">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-[#181818] border border-[#282828] p-5 sm:p-6 shadow-xl">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3.5">
                  {user.avatarUrl ? (
                    <div className="relative w-12 h-12 rounded-full overflow-hidden ring-2 ring-[#1DB954]/60 shadow-lg shrink-0">
                      <Image
                        src={user.avatarUrl}
                    ...
                    <div className="w-12 h-12 rounded-full bg-[#242424] border border-[#282828] flex items-center justify-center text-lg font-bold text-white shadow-lg shrink-0">
                  ...
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#1DB954]/10 border border-[#1DB954]/25 text-[#1DB954] text-[11px] font-medium">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#1DB954]" />
                        Spotify Connected
                      </span>
                    </div>
                    <p className="text-xs text-[#B3B3B3]">
                      Select an experience mode and search for any tour artist to get started.
                    </p>
                  </div>
                </div>

                <div className="hidden md:flex items-center gap-2 text-xs text-[#B3B3B3] bg-[#242424] border border-[#282828] px-3 py-1.5 rounded-full">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#1DB954]" />
                  <span>Full Playlist Creation Enabled</span>
                </div>
              </div>
            </div>

            {/* Interactive Spotify Setlist Wizard */}
            <div className="p-5 sm:p-8 rounded-2xl bg-[#181818] border border-[#282828] shadow-2xl">
              <WizardProvider>
                <WizardContainer />
              </WizardProvider>
            </div>
          ...
          /* =========================================================
              UNAUTHENTICATED VIEW: SPOTIFY CONNECT HERO & CTA
             ========================================================= */
          <div className="relative overflow-hidden rounded-2xl bg-[#181818] border border-[#282828] p-6 sm:p-10 shadow-2xl">
            <div className="max-w-2xl space-y-4">
              ...
              {/* Main Connect Spotify Action */}
              <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                <button
                  onClick={login}
                  className="group inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-[#1DB954] hover:bg-[#1ed760] text-black font-bold text-sm shadow-xl shadow-[#1DB954]/25 hover:shadow-[#1DB954]/40 hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer"
                >
                  <svg
