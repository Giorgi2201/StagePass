    ...
    <div className="w-full space-y-8 animate-in fade-in duration-300">
      ...
      {isAuthenticated && user ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
          {/* Column 1: Spotify Account Profile, Stateless Security, Disconnect */}
          <div className="space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-neutral-900/60 border border-neutral-800 flex items-start gap-3.5 shadow-xl">
              <ShieldCheck className="w-5 h-5 text-[#1DB954] shrink-0 mt-0.5" />
              <div className="space-y-1 text-xs">
                <div className="font-bold text-white text-sm">Stateless Security Architecture</div>
            ...
            <div className="pt-2">
              {isConfirmingDisconnect ? (
                <div className="p-5 rounded-2xl bg-red-950/30 border border-red-800/60 space-y-3 animate-in fade-in duration-150">
          ...
          {/* Column 2: Default Ticket Theme Selector, Stadium-Ready Offline PWA */}
          <div className="space-y-6">
