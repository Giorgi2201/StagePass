  ...
  return (
    <div className="w-full space-y-8 animate-in zoom-in-95 duration-300">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        {/* Left Column: Playlist Creation Success Card & Direct Actions */}
        ...
        {/* Right Column: Commemorative Ticket Stub Teaser Card, Unmatched Tracks, & Create Another Playlist */}
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-neutral-900 via-[#1a1520] to-neutral-900 border border-pink-500/30 p-5 sm:p-6 shadow-xl space-y-4">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-600 hover:from-pink-400 hover:to-indigo-500 text-white font-extrabold text-sm shadow-lg shadow-pink-500/25 active:scale-[0.98] transition-all cursor-pointer"
              >
                <Ticket className="w-4 h-4" />
                <span>Customize & Share Ticket Stub</span>
              </button>
            </div>
          </div>
          ...
          {/* Create Another Playlist Card */}
          <div className="p-6 rounded-2xl bg-[#181818] border border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl">
            <div className="space-y-0.5 text-center sm:text-left">
              <div className="text-sm font-bold text-white">Ready for another concert?</div>
              <div className="text-xs text-[#B3B3B3]">Search for another artist or build a rehearsal setlist.</div>
            </div>
            <button
              type="button"
              onClick={resetWizard}
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-neutral-900 hover:bg-neutral-800 border border-neutral-700 text-xs font-semibold text-zinc-300 hover:text-white transition-all cursor-pointer shrink-0"
            >
