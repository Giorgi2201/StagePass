  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      {!isLoadingShows && shows.length === 0 ? (
        <div className="p-8 sm:p-10 rounded-2xl bg-gradient-to-b from-[#222222] via-[#181818] to-[#121212] border border-neutral-800 shadow-2xl text-center space-y-6 max-w-xl mx-auto">
                ...
                {shows.map((show) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isLoadingParse}
                      className="group relative flex items-start gap-4 p-4 rounded-xl bg-[#181818] hover:bg-[#242424] border border-neutral-800/80 hover:border-neutral-700 active:scale-[0.98] transition-all text-left shadow-md disabled:opacity-50 cursor-pointer"
                    >
                      {/* Stylized Date Badge */}
